...
data Extension_visual a=Page {window_id::Int,arrange::Arrange,x::FCT.CFloat,y::FCT.CFloat,half_width::FCT.CFloat,half_height::FCT.CFloat,inner_thickness::FCT.CFloat,outer_thickness::FCT.CFloat,step_size::FCT.CFloat,dirty::Bool,hovered::Bool,pressed::Bool,color::Color,outer_color::Color,hovered_color::Color,outer_hovered_color::Color,selected_color::Color,outer_selected_color::Color,hovered_selected_color::Color,outer_hovered_selected_color::Color,text::Visual a,key_setting_request::DM.Map (DHS.HashSet Key) Page_action,key_setting::DHMS.HashMap Integer Page_action,strict_exist::Bool,strict_match::Bool}|Button {window_id::Int,arrange::Arrange,x::FCT.CFloat,y::FCT.CFloat,half_width::FCT.CFloat,half_height::FCT.CFloat,inner_thickness::FCT.CFloat,outer_thickness::FCT.CFloat,dirty::Bool,hovered::Bool,pressed::Bool,color::Color,outer_color::Color,hovered_color::Color,outer_hovered_color::Color,pressed_color::Color,outer_pressed_color::Color,hovered_pressed_color::Color,outer_hovered_pressed_color::Color,text::Visual a,strict_exist::Bool,strict_match::Bool}|Slider {window_id::Int,leaf_id::Int,selector::Selector (),getter::Widget a->(FCT.CFloat,FCT.CFloat,FCT.CFloat),setter::FCT.CFloat->FCT.CFloat->Maybe (Widget a->Widget a),arrange::Arrange,x::FCT.CFloat,y::FCT.CFloat,half_width::FCT.CFloat,half_height::FCT.CFloat,inner_thickness::FCT.CFloat,outer_thickness::FCT.CFloat,min_thumb_length::FCT.CFloat,step_size::FCT.CFloat,thumb_length::FCT.CFloat,thumb_position::FCT.CFloat,drag_position::FCT.CFloat,drag_offset::FCT.CFloat,cached_offset::FCT.CFloat,horizontal::Bool,dirty::Bool,thumb_state::Slider_state,first_triangle_state::Slider_state,second_triangle_state::Slider_state,color::Color,outer_color::Color,triangle_color::Color,triangle_hovered_color::Color,triangle_pressed_color::Color,thumb_color::Color,thumb_hovered_color::Color,thumb_pressed_color::Color,strict_exist::Bool,strict_match::Bool}|Custom_extension_visual {custom::Custom_extension_visual a}

data Extension_visual_request a=Page_request {window_id::Int,arrange::Arrange,x::FCT.CFloat,y::FCT.CFloat,page_width::FCT.CFloat,page_height::FCT.CFloat,inner_thickness::FCT.CFloat,outer_thickness::FCT.CFloat,step_size::FCT.CFloat,failure_advance::FCT.CFloat,failure_left::FCT.CFloat,failure_down::FCT.CFloat,failure_right::FCT.CFloat,failure_up::FCT.CFloat,max_search_index::Int,calculate_width::DS.Seq Row->DS.Seq (DS.Seq Row)->Int->FCT.CFloat,calculate_typesetting::DS.Seq (DS.Seq Row)->Int->Int->(FCT.CFloat,FCT.CFloat,FCT.CFloat),anchor::Anchor,article::DS.Seq (DS.Seq Sentence),load::Bool,color::Color,outer_color::Color,hovered_color::Color,outer_hovered_color::Color,selected_color::Color,outer_selected_color::Color,hovered_selected_color::Color,outer_hovered_selected_color::Color,key_setting_request::DM.Map (DHS.HashSet Key) Page_action,strict_exist::Bool,strict_match::Bool}|Button_request {window_id::Int,arrange::Arrange,x::FCT.CFloat,y::FCT.CFloat,button_width::FCT.CFloat,button_height::FCT.CFloat,inner_thickness::FCT.CFloat,outer_thickness::FCT.CFloat,anchor::Anchor,article::DS.Seq (DS.Seq Sentence),load::Bool,color::Color,outer_color::Color,hovered_color::Color,outer_hovered_color::Color,pressed_color::Color,outer_pressed_color::Color,hovered_pressed_color::Color,outer_hovered_pressed_color::Color,strict_exist::Bool,strict_match::Bool}|Slider_request {window_id::Int,leaf_id::Int,selector::Selector (),getter::Widget a->(FCT.CFloat,FCT.CFloat,FCT.CFloat),setter::FCT.CFloat->FCT.CFloat->Maybe (Widget a->Widget a),arrange::Arrange,x::FCT.CFloat,y::FCT.CFloat,slider_width::FCT.CFloat,slider_height::FCT.CFloat,inner_thickness::FCT.CFloat,outer_thickness::FCT.CFloat,min_thumb_length::FCT.CFloat,step_size::FCT.CFloat,horizontal::Bool,color::Color,outer_color::Color,triangle_color::Color,triangle_hovered_color::Color,triangle_pressed_color::Color,thumb_color::Color,thumb_hovered_color::Color,thumb_pressed_color::Color,strict_exist::Bool,strict_match::Bool}|Custom_extension_visual_request {custom::Custom_extension_visual_request a}
