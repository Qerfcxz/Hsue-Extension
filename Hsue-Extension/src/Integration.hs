...
create_extension_widget_request::ET.Has_call_stack=>(Event a->Engine b a c d e->Maybe Int)->(Engine b a c d e->Engine b a c d e)->Extension_widget_request b a c d e->Widget_request b a c d e
...
maybe_update_collect_extension_widget::ET.Has_call_stack=>Custom_widget e=>Tag->Maybe (Border FCT.CFloat)->Projection_path->Int->Selector a->Insert_strategy->Engine b c d e f->Engine b c d e f
...
maybe_collect_update_extension_widget::ET.Has_call_stack=>Custom_widget e=>Tag->Maybe (Border FCT.CFloat)->Projection_path->Int->Selector a->Insert_strategy->Engine b c d e f->Engine b c d e f
...
collect_extension_widget::ET.Has_call_stack=>Custom_widget e=>Tag->Maybe (Border FCT.CFloat)->Projection_path->Int->Selector a->Insert_strategy->Engine b c d e f->Engine b c d e f
