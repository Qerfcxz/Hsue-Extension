...
maybe_update_collect_extension_widget::ET.Has_call_stack=>Custom b=>Tag->Maybe (Border FCT.CFloat)->Projection_path->Int->Selector a->Insert_strategy->Engine b->Engine b
...
maybe_collect_update_extension_widget::ET.Has_call_stack=>Custom b=>Tag->Maybe (Border FCT.CFloat)->Projection_path->Int->Selector a->Insert_strategy->Engine b->Engine b
...
collect_extension_widget::ET.Has_call_stack=>Custom b=>Tag->Maybe (Border FCT.CFloat)->Projection_path->Int->Selector a->Insert_strategy->Engine b->Engine b
