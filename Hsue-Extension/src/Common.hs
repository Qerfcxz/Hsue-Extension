...
above_extension_widget::ET.Has_call_stack=>Int->FCT.CFloat->FCT.CFloat->Widget a b c d e->Bool
...
create_triangle_request::ET.Has_call_stack=>FCT.CFloat->FCT.CFloat->Color->Point->Point->Point->Visual_request
...
extract_extension_widget_vector::ET.Has_call_stack=>Widget a b c d e->DV.Vector (Widget a b c d e)
...
modify_extension_widget::ET.Has_call_stack=>(Widget a b c d e->Widget a b c d e)->Widget a b c d e->Widget a b c d e
...
view_extension_widget::ET.Has_call_stack=>(DV.Vector (Widget a b c d e)->Widget a b c d e)->Widget a b c d e->Widget a b c d e
view_extension_widget view_vector this_widget=view_vector (extract_extension_widget_vector this_widget)

update_extension_widget::ET.Has_call_stack=>Int->Widget a b c d e->Maybe (Widget a b c d e)
...
view_vector_bool::ET.Has_call_stack=>Widget a b c d e->Int->Bool
...
update_vector_bool::ET.Has_call_stack=>(Bool->Bool)->Int->Widget a b c d e->Widget a b c d e
update_vector_bool update index=update_vector_widget index (update_store_widget update)

view_extension_visual::ET.Has_call_stack=>Int->Int->Int->Int->Int->Int->Int->Int->Int->Int->DV.Vector (Widget a b c d e)->Widget a b c d e
