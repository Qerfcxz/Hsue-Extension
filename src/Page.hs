...
view_page this_widget=case this_widget of
    Widget_trigger {widget}->case widget of
        Vector {vector_widget}->case vector_widget DV.! extension_page_visual_index of
            Vector_visual {arrange,size,vector_visual}->let hovered=get_store_widget (vector_widget DV.! extension_page_hovered_index) in let offset=if get_store_widget (vector_widget DV.! extension_page_selected_index) then if hovered then extension_page_selected_hovered_offset else extension_page_selected_unhovered_offset else if hovered then extension_page_unselected_hovered_offset else extension_page_unselected_unhovered_offset in Vector_visual {arrange=arrange,collect_order=(extension_page_outer_rectangle_base_offset+offset) DS.<| (extension_page_inner_rectangle_base_offset+offset) DS.<| DS.singleton extension_page_text_visual_index,size=size,vector_visual=vector_visual}
