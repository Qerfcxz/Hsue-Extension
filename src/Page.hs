...
extension_page_visual_index::ET.Has_call_stack=>Int
extension_page_visual_index=0

extension_page_hovered_index::ET.Has_call_stack=>Int
extension_page_hovered_index=1

extension_page_selected_index::ET.Has_call_stack=>Int
extension_page_selected_index=2

extension_page_dirty_index::ET.Has_call_stack=>Int
extension_page_dirty_index=3

extension_page_window_id_index::ET.Has_call_stack=>Int
extension_page_window_id_index=4

extension_page_text_visual_index::ET.Has_call_stack=>Int
extension_page_text_visual_index=0

extension_page_inner_rectangle_index::ET.Has_call_stack=>Int
extension_page_inner_rectangle_index=1

extension_page_root_vector_index::ET.Has_call_stack=>Int
extension_page_root_vector_index=0

extension_page_unselected_unhovered_offset::ET.Has_call_stack=>Int
extension_page_unselected_unhovered_offset=0

extension_page_unselected_hovered_offset::ET.Has_call_stack=>Int
extension_page_unselected_hovered_offset=2

extension_page_selected_unhovered_offset::ET.Has_call_stack=>Int
extension_page_selected_unhovered_offset=4

extension_page_selected_hovered_offset::ET.Has_call_stack=>Int
extension_page_selected_hovered_offset=6

extension_page_inner_rectangle_base_offset::ET.Has_call_stack=>Int
extension_page_inner_rectangle_base_offset=1

extension_page_outer_rectangle_base_offset::ET.Has_call_stack=>Int
extension_page_outer_rectangle_base_offset=2

update_text::ET.Has_call_stack=>(Visual->Visual)->Visual->(Visual,Bool)
...
scroll_page::ET.Has_call_stack=>(Visual->Visual)->Widget a b c d e->Widget a b c d e
scroll_page transform widget=case widget of
    Vector {vector_widget}->case vector_widget DV.! extension_page_visual_index of
        Vector_visual {arrange,collect_order,vector_visual,size}->let (new_text_visual,changed)=update_text transform (vector_visual DV.! extension_page_text_visual_index) in if changed then update_vector_bool (const True) extension_page_dirty_index (update_vector_widget extension_page_visual_index (const (Vector_visual {arrange=arrange,collect_order=collect_order,vector_visual=DV.modify (\this_vector_widget->DVM.write this_vector_widget extension_page_text_visual_index new_text_visual) vector_visual,size=size})) widget) else widget
        _->EF.empty_error
    _->EF.empty_error

create_page_request::ET.Has_call_stack=>(Event a->Engine b a c d e->Maybe Int)->(Event a->Engine b a c d e->Widget b a c d e->(Widget b a c d e,Engine b a c d e->Engine b a c d e))->Extension_widget_request b a c d e->Widget_request b a c d e
...
page_widget_trigger::ET.Has_call_stack=>FCT.CFloat->Event a->Engine b a c d e->Widget b a c d e->(Widget b a c d e,Engine b a c d e->Engine b a c d e)
...
view_page::ET.Has_call_stack=>Widget a b c d e->Widget a b c d e
...
update_page::ET.Has_call_stack=>Widget a b c d e->Maybe (Widget a b c d e)
