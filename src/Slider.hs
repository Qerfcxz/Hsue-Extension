...
extension_slider_outer_rectangle_visual_index::Int
extension_slider_outer_rectangle_visual_index=0

extension_slider_inner_rectangle_visual_index::Int
extension_slider_inner_rectangle_visual_index=1

extension_slider_state_normal::Int
extension_slider_state_normal=0

extension_slider_state_hovered::Int
extension_slider_state_hovered=1

extension_slider_state_pressed::Int
extension_slider_state_pressed=2

extension_slider_horizontal_flag_false::Int
extension_slider_horizontal_flag_false=0

extension_slider_horizontal_flag_true::Int
