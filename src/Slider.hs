...
view_slider this_widget=case this_widget of
    Widget_trigger {widget}->case widget of
        Vector {vector_widget}->case vector_widget DV.! extension_slider_visual_index of
            Vector_visual {arrange=first_arrange,size=visual_size,vector_visual}->let first_triangle_state=get_store_widget (vector_widget DV.! extension_slider_first_triangle_state_index) in let second_triangle_state=get_store_widget (vector_widget DV.! extension_slider_second_triangle_state_index) in let thumb_state=get_store_widget (vector_widget DV.! extension_slider_thumb_state_index) in let thumb_length=get_store_widget (vector_widget DV.! extension_slider_thumb_length_index) in let thumb_position=get_store_widget (vector_widget DV.! extension_slider_thumb_position_index) in let horizontal=(get_store_widget (vector_widget DV.! extension_slider_horizontal_index)::Int)==1 in let x=get_store_widget (vector_widget DV.! extension_slider_x_index) in let y=get_store_widget (vector_widget DV.! extension_slider_y_index) in let thumb_visual=vector_visual DV.! (extension_slider_thumb_visual_base_index+thumb_state) in case thumb_visual of
